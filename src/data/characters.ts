...
export const characters: Character[] = [
	// Protagonists
	{
		...
		slug: 'anna-lam',
		role: 'the Engineer',
		description: 'When her mentor dies under suspicious circumstances, former AI engineer Anna Lam descends into FedoraCon, a bizarre 24-hour anime convention, searching for answers.',
		image: null,
		type: 'protagonist',
	...
	},
	{
		name: 'Susie Swanson',
		slug: 'susie-swanson',
		role: 'aka "Shojo Sheriff and Weeb Detective"',
		description: 'Convention enforcer and internal investigator. Cheerful, competent, and looking for an outsider\'s perspective on FedoraCon\'s strange happenings. When she sponsors Anna into the convention, she might finally get the help she needs.',
		image: null,
		type: 'protagonist',
	...
	// Antagonists
	{
		...
		description: 'Crypto-billionaire founder of FedoraCon. With his patented Hard Light technology and seemingly limitless resources, Fedora Mask is on a mission to make anime a reality and change fandom forever.',
		image: null,
		type: 'antagonist',
	...
	},
	{
		...
		description: 'Halloween isn\'t a holiday for Bea Beatrix, it\'s a lifestyle. As judge of the Artist Alley, she offers one consistent critique to every artist: could this be spookier? To Bea, the answer is always yes.',
		image: null,
		type: 'antagonist',
		bio: 'Bea Beatrix doesn\'t celebrate Halloween. Halloween celebrates Bea Beatrix. At FedoraCon, she serves as the gatekeeper of the Artist Alley, where she judges submissions and offers critiques to aspiring artists.\n\nA devoted Hallowcore lifestyle influencer, Bea has built her entire existence around spooky aesthetics. She genuinely cannot understand why everyone doesn\'t share her singular devotion to pumpkins, skeletons, witches, and all things Halloween. Her critiques often boil down to one simple question: could this be spookier? To Bea, the answer is always yes.',
	},
	{
		name: 'J-Woo',
		slug: 'j-woo',
		role: 'Former K-Pop Star, Dance Master',
		description: 'Once a member of K-Pop group 3NIX, J-Woo walked away from stardom to dedicate himself to a vow of uninterrupted dance.',
		image: null,
		type: 'antagonist',
		bio: 'Son Jae-woo, known as J-Woo, was once a rising star in the K-Pop group 3NIX. At the height of his fame, he walked away from sold-out stadiums to honor his vow of uninterrupted dance. Since then, he\'s traveled the world learning from dance masters both human and animal, turning movement itself into meditation.\n\nJ-Woo doesn\'t speak. He communicates entirely through dance, with the Woo Crew, his three most loyal fans, translating his movements into words. At FedoraCon\'s Ballroom Wing, every gesture is deliberate, every step calculated. To J-Woo, dance isn\'t performance. It\'s a sacred commitment he\'s never broken.',
	},
	{
		name: 'May Melody',
		slug: 'may-melody',
		role: 'Kawaii Influencer, Content Creator, Streamer',
		description: 'Kawaii influencer and streamer sponsored by Kawaii Couture, a Bae Capital Holdings company (we\'re legally obligated to write this). May Melody runs FedoraCon\'s Cosplay Contest, turning every moment into content for her massive audience.',
		image: null,
		type: 'antagonist',
	...
	},
	{
		...
		slug: 'jared-jimenez',
		role: 'The Collector',
		description: 'Heralding himself as the "ultimate" collector, Jared strives to collect rare collectables. On his mind are four sacred Chiibos, vinyl collectable figures, that are rumored to possess ancient druidic power.',
		image: null,
		type: 'antagonist',
